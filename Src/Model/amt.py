...
class Snomed(Base, db.Model):
    """
    Snomed class represents an ORM model for the Flask applications SNOMED distribution
    SQLite database table.

    :param Base: The models declarative base, used for automapping relationships
    :type Base: automap_base
...
class Amt(Base, db.Model):
    """
    Amt class represents an ORM model for the Flask applications AMT distribution
    SQLite database table.
